...
# ECS Config
ECS_JOBS_CLUSTER=config.ECS_JOBS_CLUSTER
ECS_JOB_ITEMS_CLUSTER=config.ECS_JOB_ITEMS_CLUSTER
ECS_JOBS_SERVICE=config.ECS_JOBS_SERVICE
ECS_JOB_ITEMS_SERVICE=config.ECS_JOB_ITEMS_SERVICE
ECS_JOBS_TASK=config.ECS_JOBS_TASK
ECS_JOB_ITEMS_TASK=config.ECS_JOB_ITEMS_TASK

# AWS Autoscaling Config
AUTOSCALING_GROUP_JOBS=config.AUTOSCALING_GROUP_JOBS
AUTOSCALING_GROUP_JOB_ITEMS=config.AUTOSCALING_GROUP_JOB_ITEMS
